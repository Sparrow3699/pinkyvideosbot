...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7119733558:AAHpzVK3xi66NadQqazpIe3SToLvfZO9uHg")
...
#start message
START_MSG = os.environ.get("START_MESSAGE", "Hello {first}\n\n bro join 1.@Science2_0 2.@Digipoddi & https://t.me/+q97R_ztFeskwMzcx  3 channels Unlimited 24/7 🔞Viral Videos🤤.")
try:
    ADMINS=[]
